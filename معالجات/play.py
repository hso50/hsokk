        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton("قناه السورس", url=f"https://t.me/QQ5QQ4")
                ],
            ]
        )
        file_name = get_file_name(audio)
        title = file_name
        thumb_name = "https://telegra.ph/hhsooy-06-17"
    ...
    keyboard = InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton("قناة السورس", url=f"https://t.me/QQ5QQ4")
                ],
            ]
    )
